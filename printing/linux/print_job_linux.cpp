...
#include "print_job_linux.h"

namespace printing {

PrintJobLinux::PrintJobLinux(std::shared_ptr<PrintingPlugin> printing,
                             int index)
    : PrintJob(printing, index) {}

flutter::EncodableMap PrintJobLinux::printingInfo() {
